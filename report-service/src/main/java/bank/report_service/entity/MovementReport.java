...
@Entity
@Table(name = "tbl_movement_report")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class MovementReport {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "movement_report_seq")
    @SequenceGenerator(name = "movement_report_seq", sequenceName = "movement_report_seq", allocationSize = 1)
    @Column(name = "movement_report_id")
